...
ERROR_LOG_FILENAME = 'platform.error.log'
...
LOGGING_CONFIG = {
    ...
    "handlers": {
        "logfile_error": {  # The handler name
        ...
        "logfile": {  # The handler name
            "formatter": "default",  # Refer to the formatter defined above
            "level": "INFO",  # FILTER: All logs except DEBUG
            "class": "logging.handlers.RotatingFileHandler",  # OUTPUT: Which class to use
    ...
    "loggers": {
        "platform": {  # The name of the logger, this SHOULD match your module!
